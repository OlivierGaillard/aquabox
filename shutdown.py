...
class WakeUp:
    ...
    def __init__(self, poolSettings):
        ...
        self.delta_hours = self.poolsettings.time_beetween_readings()
    ...
    def prepare_wakeup(self):
        ...
        a['hour'] = t.hour + self.delta_hours
        a['minute'] = 0
        a['second'] = 0
        ...
        if status['error'] != 'NO_ERROR':
            ...
            logging.info('Alarm set for %s' % str(self.pj.rtcAlarm.GetAlarm()))
            print('Alarm set for ' + str(self.pj.rtcAlarm.GetAlarm()))
